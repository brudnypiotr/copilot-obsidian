---
description: Bootstrap or check the copilot-obsidian wiki vault. Reads the wiki skill and runs setup workflow.
---
...
3. Check if an MCP server for Obsidian is configured (consult the agent's MCP server list). If not, ask if the user wants to set it up.
